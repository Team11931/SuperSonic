 ...
 *
 **/
@Autonomous(name="Supersonic Autonomous Lander (Crater only - from Depot Side)", group ="Supersonic")
// @Disabled
public class myAutonomousOpModeNonLoopDepotLander extends LinearOpMode {
